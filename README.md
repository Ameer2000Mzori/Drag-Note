...
> Drag-Note is a website created with HTML, SCSS, and TypeScript. It utilizes local storage to save data, and linters are employed to overcome code errors and maintain clean code. Please check out the live demo.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Drag-Note/src/)
